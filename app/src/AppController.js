 ...
 * @constructor
 */
function AppController($mdSidenav, $http, $rootScope, $scope, $location, $mdMedia, $window,  $httpParamSerializerJQLike) {
    'use strict';
    var self = this;
    var map = null,
        view = null;
...
export default ['$mdSidenav', '$http', '$rootScope', '$scope', '$location', '$mdMedia', '$window', '$httpParamSerializerJQLike', AppController];